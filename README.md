...
- locale/en_US/greetings.json: ```json {"hello":"Hello!", "welcome":"Welcome to my site, %0!"} ```
- locale/ro_RO/greetings.json: ```json {"hello":"Salut!", "welcome":"Bun venit pe situl meu, %0!"} ```
